...
@section('title')
<title>Quản lý hỏi đáp chuyên gia</title>
@endsection
                        ...
                        <tbody>
                            ...
                            @foreach ($experts as $expert)
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold text-xs">{{ $expert->title }}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold text-xs">{{ date('Y-m-d H:i:s', strtotime($expert->created_at)) }}</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.expert.show', $expert->id) }}" class="btn btn-info">Sửa</a>
                                        <a onclick="return confirm('Are you sure?')" href="{{ route('admin.expert.delete', $expert->id) }}" class="btn btn-danger">Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
