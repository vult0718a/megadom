                    ...
                    <div class="card-body" style="width: 50%">
                        <form method="POST" action="{{ route('admin.newspaper.update', $newspaper->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_content" id="content" class="form-control" style="height: 150px;" placeholder="Nội dung">{{ old('short_content', $newspaper->short_content) }}</textarea>
                            </div><br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('storage/images/newspaper/'.$newspaper->id.'/image.png') }}" id="previewHolder" class="form-control">
                            </div><br>
                            @error('name')
