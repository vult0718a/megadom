...
@section('title')
<title>Quản lý bài viết câu chuyện khách hàng</title>
@endsection
        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white ps-3" style="display: inline-block;">Danh sách bài viết câu chuyện khách hàng</h6>
                        ...
                        <tbody>
                            ...
                            @foreach ($storys as $story)
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold text-xs">{{ $story->title }}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold text-xs">{{ date('Y-m-d H:i:s', strtotime($story->created_at)) }}</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.story.show', $story->id) }}" class="btn btn-info">Sửa</a>
                                        <a onclick="return confirm('Are you sure?')" href="{{ route('admin.story.delete', $story->id) }}" class="btn btn-danger">Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
