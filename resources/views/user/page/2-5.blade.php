...
<div class="screen2-5">
    <div class="banner">
      <div class="text-banner">
        ...
        <p class="text-bold">Phẫu thuật làm to viền quy đầu</p>
      </div>
    </div>
    ...
    <div class="expression container">
        <div class="row">
          <div class="left col-xl-6 col-lg-6 col-sm-12 col-12">
            <img id="expression-image-1" src="/frontend/images/home-penile-1.png">
          </div>
    ...
    <div class="expression container">
      <div class="row">
        ...
        <div class="right col-xl-6 col-lg-6 col-sm-12 col-12">
          <img id="expression-image-1" src="/frontend/images/Rectangle-105.png">
        </div>
      </div>
      <div class="row row-2">
        <div class="left col-xl-6 col-lg-6 col-sm-12 col-12">
    ...
    <div class="qa container">
        <div class="left col-xl-6 col-lg-6 col-sm-12 col-12">
            ...
            <p class="text-medium">The general technique used during penile reconstruction is called radial artery-based forearm phalloplasty, or RAP. Within your forearm, there are two large arteries which supply the forearm with blood. During RAP, one of the arteries and at least one large nerve as well as external skin and the soft tissue which protects the bone is removed and rolled into a tube. Dr. Elist will attach this neophallus to the blood and nerve tissues in the groin. You may also choose to have a penile implant installed at this time in order to achieve an erection.</p>
            <div class="block-contact">LIÊN HỆ CHUYÊN GIA</div>
          </div>
        <div class="right col-xl-6 col-lg-6 col-sm-12 col-12">
            <img id="expression-image-1" src="/frontend/images/Rectangle-140.png">
        </div>
    </div>
  </div>
