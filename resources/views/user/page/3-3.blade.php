...
@section('style')
<link rel="stylesheet" type="text/css" href="/user/page/3-3.css">
...
<div class="screen3-3">
    <div class="banner">
      <div class="text-banner">
        <p class="text-medium">TRANG CHỦ. PHẪU THUẬT NAM KHOA. BỆNH LÝ TINH HOÀN</p>
    ...
    <div class="expression container">
      <div class="row">
        ...
        <div class="right col-xl-6 col-lg-6 col-sm-12 col-12">
          <img id="expression-image-1" src="/frontend/images/rectangle3-2-4.png">
        </div>
      </div>
    </div>
    <div class="chose">
    ...
    <div class="expression container">
      <div class="row">
        ...
        <div class="right col-xl-6 col-lg-6 col-sm-12 col-12">
          <img id="expression-image-1" src="/frontend/images/rectangle3-3-5.png">
        </div>
      </div>
      <div class="row row-2">
        <div class="left col-xl-6 col-lg-6 col-sm-12 col-12">
          <img id="expression-image-2" src="/frontend/images/rectangle3-3-6.png">
        </div>
        <div class="right col-xl-6 col-lg-6 col-sm-12 col-12">
