  ...
  <div class="contact-screen">
    <div class="banner">
      <div class="text-banner">
        <p class="text-medium">TRANG CHỦ. LIÊN HỆ</p>
        <p class="text-bold">Liên hệ</p>
      </div>
    </div>
    <div class="form-input">
      <p class="name">PHÒNG KHÁM NAM KHOA MEGADOM</p>
      <div class="contact contact-1 text-medium"><img id="icon" src="/frontend/images/phone.png"><span>098 534 2323</span></div>
      <div class="contact contact-2 text-medium"><img id="icon" src="/frontend/images/vector1a.png"><span>megaderm.vn@gmail.com</span></div>
      <div class="contact contact-3 text-medium"><img id="icon" src="/frontend/images/vector1b.png"><span>Tầng 2, Bệnh viện Đức Phúc- Số 48 P. Ô Đồng Lâm, Phương Liên, Đống Đa, Hà Nội</span></div>
      <form>
        <div class="input-block">
          ...
          <div class="rule-title text-small">Điều khoản dịch vụ<span>*</span></div>
          <div class="rules">
            <textarea class="rules-content">By submitting this form I give Megadom, a Medical Corporation, Penuma, and its affiliates permission to contact me and agree to the terms of the <span>Privacy Policy</span>.</textarea>
