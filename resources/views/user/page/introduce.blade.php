...
@section('content')
  <div class="introduce">
    ...
    <img id="image-1" src="/frontend/images/image14.png">
    <div class="booking">
    ...
    <div class="value">
      ...
      <div class="value-1">
        <p class="value-title-1">GIÁ TRỊ CỐT LÕI</p>
        <hr>
      </div>
      <div class="value-2">
        <img src="/frontend/images/value-2.png">
        <p class="value-title-2">BẢO MẬT</p>
        <p class="value-content-2">Luôn đảm bảo nghiêm ngặt tính bảo mật của thông tin khi tương tác với bệnh nhân và các thành viên trong cộng đồng.</p>
      </div>
      <div class="value-3">
        <img src="/frontend/images/value-3.png">
        <p class="value-title-3">TRÁCH NHIỆM</p>
        <p class="value-content-3">Đội ngũ y bác sĩ, nhân viên phòng khám luôn hành xử với tinh thần trách nhiệm, chuẩn mực và đạo đức nghề nghiệp cao nhất đối với bệnh nhân và cộng đồng."</p>
      </div>
      <div class="value-4">
        <img src="/frontend/images/value-4.png">
        <p class="value-title-4">CHẤT LƯỢNG KHÁM CHỮA BỆNH TIÊU CHUẨN QUỐC TẾ</p>
        <p class="value-content-4">Theo đuổi hướng đến những kết quả điều trị tốt nhất, luôn tự hoàn thiện và phục vụ vượt mong đợi. </p>
      </div>
      <div class="value-5">
        <img src="/frontend/images/value-5.png">
        <p class="value-title-5">LẤY BỆNH NHÂN LÀM TRUNG TÂM</p>
        <p class="value-content-5">Phòng khám có quy trình dịch vụ được thiết kế riêng tùy theo thông tin và yêu cầu của mỗi khách hàng, đặt lợi ích khách hàng lên hàng đầu, không thiên vị về các lựa chọn, lợi ích và rủi ro.</p>
      </div>
      <div class="value-6">
        <img src="/frontend/images/value-6.png">
        <p class="value-title-6">CHUYÊN MÔN CAO CÔNG NGHỆ ĐỘC QUYỀN</p>
        <p class="value-content-6">Bác sĩ chuyên môn đầu ngành trong lĩnh vực Nam học ở Việt Nam. Công nghệ phẫu thuật và chất liệu phẫu thuật từ Hàn Quốc tiên phong và độc quyền sử dụng.</p>
      </div>
    </div>
    <img id="delicious-image" src="/frontend/images/image16b.png">
    ...
    <div class="difference">
      <p class="difference-title"><span>ĐIỂM KHÁC BIỆT CỦA</span> MEGADOM</p>
      <hr>
    </div>
    <div class="difference-block-1">
      <p class="difference-title-1">CHUYÊN BIỆT VÀ ĐỘC QUYỀN</p>
      <p class="difference-content-1">Phòng khám chuyên về kỹ thuật làm to và làm dài dương vật với công nghệ và kỹ thuật phẫu thuật tạo hình dương vật bằng tấm độn sinh học MEGADERM độc quyền.</p>
    </div>
    <div class="difference-block-2">
      <p class="difference-title-2">BẢO HÀNH TRỌN ĐỜI</p>
      <p class="difference-content-2">Chúng tôi cam kết mang lại trải nghiệm hài lòng nhất cho khách hàng và bảo hành trọn đời các dịch vụ độc quyền cung cấp.</p>
    </div>
    <div class="difference-block-3">
      <p class="difference-title-3">HIỆU QUẢ CAO - AN TOÀN - TỰ NHIÊN</p>
      <p class="difference-content-3">Với bác sĩ có chuyên môn, kinh nghiệm cao, chúng tôi hoàn toàn đảm bảo kết quả điều trị và phẫu thuật an toàn, tự nhiên nhất có thể.</p>
    </div>
    <div class="difference-block-4">
      <p class="difference-title-4">DỊCH VỤ CHĂM SÓC CÁ NHÂN HÓA</p>
      <p class="difference-content-4">Chúng tôi cung cấp dịch vụ thăm khám, chữa bệnh được thiết kế riêng cho từng bệnh nhân. Chúng tôi tôn trọng mỗi bệnh nhân/ khách hàng của mình và mong muốn cung cấp dịch vụ tốt nhất có thể.</p>
    </div>
    <div class="difference-block-5">
      <p class="difference-title-5">TRANG THIẾT BỊ Y TẾ HIỆN ĐẠI VÀ VỆ SINH</p>
      <p class="difference-content-5">Duy trì môi trường y tế vệ sinh, ngăn ngừa mọi nguy cơ nhiễm trùng là ưu tiên hàng đầu của chúng tôi.</p>
    </div>
    <div class="difference-block-6">
      <p class="difference-title-6">BÁC SĨ CHUYÊN KHOA TIẾT NIỆU- NAM HỌC HÀNG ĐẦU</p>
      <p class="difference-content-6">Các khách hàng của chúng tôi được đảm bảo nhận sự thăm khám, chữa bệnh của bác sĩ chuyên môn cao và dày dặn kinh nghiệm trong lĩnh vực này.</p>
    </div>
    <div class="difference-block-7">
      <p class="difference-title-7">BẢO MẬT 100%</p>
      <p class="difference-content-7">Chúng tôi có nguyên tắc bảo mật tối đa thông tin khách hàng để mang lại sự an toàn, thoải mái tuyệt đối cho bệnh nhân.</p>
    </div>
    <div class="difference-block-8">
