...
<link rel="stylesheet" type="text/css" href="/user/page/picture_video.css">
@endsection

@section('content')
<div class="picture-video container">
  <div class="picture-video-title">
    <p class="text-bold">THƯ VIỆN HÌNH ẢNH</p>
    <hr>
  </div>
  ...
  <div class="title-2">
    <p class="text-bold">NGHIÊN CỨU VỀ PHẪU THUẬT DƯƠNG VẬT</p>
    <hr>
  </div>
  <div class="content-2">
  ...
  <div class="title-3">
    <p class="text-bold">ĐẶT LỊCH TƯ VẤN</p>
    <hr>
  </div>
  <div class="content-3">
    ...
    <br>
    <p>Nếu bạn đã sẵn sàng để thực hiện bước tiếp theo trong hành trình lấy lại sự tự tin cho chính mình, hãy gọi cho Megadom ngay hôm nay để <a href="#">đặt lịch tư vấn</a>. Chúng tôi sẽ giúp bạn xác định phương án phẫu thuật phù hợp nhất.</p>
  </div>
</div>
@endsection