            ...
            <div class="col-xl-9 col-lg-9 col-sm-12 col-12 center-content" id="right-content">
                <div class="post-content">
                    <div class="post-content__body">
                        <img style="width:100%" src="{{ asset('public/storage/images/post/'.$post->id.'.'.$post->extension) }}" alt="Image post" width="100%" class="image_post">
                        <p class="title_post">{{ $post->title }}</p>
                        <p class="time_post">{{ date('M d, Y', strtotime($post->created_at)) }}</p>
                ...
                <a href="{{ route('post') }}" class="button-QA margin-left-18">
...
<script>
    // let html = ''; 
    // $('.content_post').find("h1").each(function() {
