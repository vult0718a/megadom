            ...
            <div class="col-xl-9 col-lg-9 col-sm-12 col-12 center-content" id="right-content">
                <div class="post-content">
                    <div class="post-content__body">
                        <img style="width:100%" src="{{ asset('public/storage/images/post/'.$story->id.'.'.$story->extension) }}" alt="Image post" width="100%" class="image_post">
                        <p class="title_post">{{ $story->title }}</p>
                        <p class="time_post">{{ date('M d, Y', strtotime($story->created_at)) }}</p>
                        ...
                        <div class="content_post_block mt-28-custom">
                            <span class="content_post">{!! $story->content !!}</span><br>
                        </div>
                    </div>
                </div>
                <a href="{{ route('cau-chuyen-khach-hang') }}" class="button-QA margin-left-18">
                    <span>TRỞ LẠI CÂU CHUYỆN KHÁCH HÀNG</span>
                </a>
            </div>
        </div>
    </div>
